...
import { FinalizeOnboardingController } from './presentation/rest/finalize-onboarding-controller';
...
@Module({
  ...
  controllers: [AppController, FinalizeOnboardingController, AccountController],
  providers: [
    {
